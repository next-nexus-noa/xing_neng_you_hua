...
class PPTraceRecorder:
    ...
    def begin_step(
        ...
        self._step_meta = {
            ...
            "queue_len": None if queue_len is None else int(queue_len),
            "selected_m": None if selected_m is None else int(selected_m),
        }
...
def _compute_dual_pp_metrics(records: list[dict[str, Any]]) -> dict[str, Any] | None:
    ...
    metrics = {
        ...
        "queue_len": records[0].get("queue_len"),
        "selected_m": records[0].get("selected_m"),
