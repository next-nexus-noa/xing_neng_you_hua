...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # PP micro-batch policy. "fixed" uses VLLM_ASCEND_PP_MICROBATCH_NUM;
    # "queue" chooses M solely from scheduler queue length for the M4 baseline.
    "VLLM_ASCEND_PP_MICROBATCH_POLICY": lambda: os.getenv(
        "VLLM_ASCEND_PP_MICROBATCH_POLICY", "fixed"
    ).lower(),
    # Queue-aware M threshold table. Format: queue_len:microbatch_num pairs.
    "VLLM_ASCEND_PP_MICROBATCH_QUEUE_THRESHOLDS": lambda: os.getenv(
        "VLLM_ASCEND_PP_MICROBATCH_QUEUE_THRESHOLDS", "0:1,4:2,16:4"
    ),
}
