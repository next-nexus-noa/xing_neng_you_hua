...
class EngineArgs:
    ...
    enable_adaptive_ubatch: bool = ParallelConfig.enable_adaptive_ubatch
    adaptive_ubatch_max_size: int = ParallelConfig.adaptive_ubatch_max_size
    adaptive_ubatch_min_gain_pct: float = ParallelConfig.adaptive_ubatch_min_gain_pct
    adaptive_ubatch_use_analytical_prior: bool = (
        ParallelConfig.adaptive_ubatch_use_analytical_prior
    )
    adaptive_ubatch_prefill_threshold_pct: float = (
        ParallelConfig.adaptive_ubatch_prefill_threshold_pct
    )
    adaptive_ubatch_warmup_steps: int = ParallelConfig.adaptive_ubatch_warmup_steps
    adaptive_ubatch_min_observations: int = (
        ParallelConfig.adaptive_ubatch_min_observations
    )
    adaptive_ubatch_explore_pct: float = ParallelConfig.adaptive_ubatch_explore_pct
    adaptive_ubatch_enable_exploration: bool = (
        ParallelConfig.adaptive_ubatch_enable_exploration
    )
    adaptive_ubatch_switch_threshold_pct: float = (
        ParallelConfig.adaptive_ubatch_switch_threshold_pct
    )
    adaptive_ubatch_bad_threshold_pct: float = (
        ParallelConfig.adaptive_ubatch_bad_threshold_pct
    )
    adaptive_ubatch_cooldown_steps: int = (
        ParallelConfig.adaptive_ubatch_cooldown_steps
    )
    adaptive_ubatch_failure_cooldown_steps: int = (
        ParallelConfig.adaptive_ubatch_failure_cooldown_steps
    )
    adaptive_ubatch_ewma_alpha: float = ParallelConfig.adaptive_ubatch_ewma_alpha
    adaptive_ubatch_disable_m4_for_large_model: bool = (
        ParallelConfig.adaptive_ubatch_disable_m4_for_large_model
    )
    adaptive_ubatch_min_tokens_m2: int = ParallelConfig.adaptive_ubatch_min_tokens_m2
    adaptive_ubatch_min_tokens_m4: int = ParallelConfig.adaptive_ubatch_min_tokens_m4
    adaptive_ubatch_min_prefill_ratio_m4: float = (
        ParallelConfig.adaptive_ubatch_min_prefill_ratio_m4
    )
    adaptive_ubatch_mode: str = ParallelConfig.adaptive_ubatch_mode
    adaptive_ubatch_risk_kappa: float = ParallelConfig.adaptive_ubatch_risk_kappa
    adaptive_ubatch_max_uncertainty_ratio: float = (
        ParallelConfig.adaptive_ubatch_max_uncertainty_ratio
    )
    adaptive_ubatch_cold_start_penalty_ratio: float = (
        ParallelConfig.adaptive_ubatch_cold_start_penalty_ratio
    )
    adaptive_ubatch_max_correction_ratio: float = (
        ParallelConfig.adaptive_ubatch_max_correction_ratio
    )
    adaptive_ubatch_max_calibration_scale: float = (
        ParallelConfig.adaptive_ubatch_max_calibration_scale
    )
    adaptive_ubatch_min_hold_steps: int = ParallelConfig.adaptive_ubatch_min_hold_steps
    adaptive_ubatch_switch_confirmations: int = (
        ParallelConfig.adaptive_ubatch_switch_confirmations
    )
    adaptive_ubatch_feedback_interval_steps: int = (
        ParallelConfig.adaptive_ubatch_feedback_interval_steps
    )
    adaptive_ubatch_candidate_calibration_observations: int = (
        ParallelConfig.adaptive_ubatch_candidate_calibration_observations
    )
    adaptive_ubatch_safe_m: int = ParallelConfig.adaptive_ubatch_safe_m
    adaptive_ubatch_exploration_interval_steps: int = (
        ParallelConfig.adaptive_ubatch_exploration_interval_steps
    )
    adaptive_ubatch_exploration_stable_steps: int = (
        ParallelConfig.adaptive_ubatch_exploration_stable_steps
    )
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parallel_group.add_argument(
            ...
            **parallel_kwargs["enable_adaptive_ubatch"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-max-size",
            **parallel_kwargs["adaptive_ubatch_max_size"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-gain-pct",
            **parallel_kwargs["adaptive_ubatch_min_gain_pct"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-use-analytical-prior",
            **parallel_kwargs["adaptive_ubatch_use_analytical_prior"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-prefill-threshold-pct",
            **parallel_kwargs["adaptive_ubatch_prefill_threshold_pct"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-warmup-steps",
            **parallel_kwargs["adaptive_ubatch_warmup_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-observations",
            **parallel_kwargs["adaptive_ubatch_min_observations"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-explore-pct",
            **parallel_kwargs["adaptive_ubatch_explore_pct"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-enable-exploration",
            **parallel_kwargs["adaptive_ubatch_enable_exploration"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-switch-threshold-pct",
            **parallel_kwargs["adaptive_ubatch_switch_threshold_pct"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-bad-threshold-pct",
            **parallel_kwargs["adaptive_ubatch_bad_threshold_pct"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-cooldown-steps",
            **parallel_kwargs["adaptive_ubatch_cooldown_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-failure-cooldown-steps",
            **parallel_kwargs["adaptive_ubatch_failure_cooldown_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-ewma-alpha",
            **parallel_kwargs["adaptive_ubatch_ewma_alpha"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-disable-m4-for-large-model",
            **parallel_kwargs["adaptive_ubatch_disable_m4_for_large_model"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-tokens-m2",
            **parallel_kwargs["adaptive_ubatch_min_tokens_m2"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-tokens-m4",
            **parallel_kwargs["adaptive_ubatch_min_tokens_m4"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-prefill-ratio-m4",
            **parallel_kwargs["adaptive_ubatch_min_prefill_ratio_m4"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-mode",
            **parallel_kwargs["adaptive_ubatch_mode"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-risk-kappa",
            **parallel_kwargs["adaptive_ubatch_risk_kappa"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-max-uncertainty-ratio",
            **parallel_kwargs["adaptive_ubatch_max_uncertainty_ratio"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-cold-start-penalty-ratio",
            **parallel_kwargs["adaptive_ubatch_cold_start_penalty_ratio"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-max-correction-ratio",
            **parallel_kwargs["adaptive_ubatch_max_correction_ratio"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-max-calibration-scale",
            **parallel_kwargs["adaptive_ubatch_max_calibration_scale"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-min-hold-steps",
            **parallel_kwargs["adaptive_ubatch_min_hold_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-switch-confirmations",
            **parallel_kwargs["adaptive_ubatch_switch_confirmations"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-feedback-interval-steps",
            **parallel_kwargs["adaptive_ubatch_feedback_interval_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-candidate-calibration-observations",
            **parallel_kwargs[
                "adaptive_ubatch_candidate_calibration_observations"
            ],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-safe-m",
            **parallel_kwargs["adaptive_ubatch_safe_m"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-exploration-interval-steps",
            **parallel_kwargs["adaptive_ubatch_exploration_interval_steps"],
        )
        parallel_group.add_argument(
            "--adaptive-ubatch-exploration-stable-steps",
            **parallel_kwargs["adaptive_ubatch_exploration_stable_steps"],
        )
        parallel_group.add_argument(
        ...
        parallel_group.add_argument(
            ...
            **parallel_kwargs["adaptive_ubatch_trace_path"],
        )
        parallel_group.add_argument(
    ...
    def create_engine_config(
        ...
        parallel_config = ParallelConfig(
            ...
            enable_adaptive_ubatch=self.enable_adaptive_ubatch,
            adaptive_ubatch_max_size=self.adaptive_ubatch_max_size,
            adaptive_ubatch_min_gain_pct=self.adaptive_ubatch_min_gain_pct,
            adaptive_ubatch_use_analytical_prior=(
                self.adaptive_ubatch_use_analytical_prior
            ),
            adaptive_ubatch_prefill_threshold_pct=(
                self.adaptive_ubatch_prefill_threshold_pct
            ),
            adaptive_ubatch_warmup_steps=self.adaptive_ubatch_warmup_steps,
            adaptive_ubatch_min_observations=self.adaptive_ubatch_min_observations,
            adaptive_ubatch_explore_pct=self.adaptive_ubatch_explore_pct,
            adaptive_ubatch_enable_exploration=(
                self.adaptive_ubatch_enable_exploration
            ),
            adaptive_ubatch_switch_threshold_pct=(
                self.adaptive_ubatch_switch_threshold_pct
            ),
            adaptive_ubatch_bad_threshold_pct=self.adaptive_ubatch_bad_threshold_pct,
            adaptive_ubatch_cooldown_steps=self.adaptive_ubatch_cooldown_steps,
            adaptive_ubatch_failure_cooldown_steps=(
                self.adaptive_ubatch_failure_cooldown_steps
            ),
            adaptive_ubatch_ewma_alpha=self.adaptive_ubatch_ewma_alpha,
            adaptive_ubatch_disable_m4_for_large_model=(
                self.adaptive_ubatch_disable_m4_for_large_model
            ),
            adaptive_ubatch_min_tokens_m2=self.adaptive_ubatch_min_tokens_m2,
            adaptive_ubatch_min_tokens_m4=self.adaptive_ubatch_min_tokens_m4,
            adaptive_ubatch_min_prefill_ratio_m4=(
                self.adaptive_ubatch_min_prefill_ratio_m4
            ),
            adaptive_ubatch_mode=self.adaptive_ubatch_mode,
            adaptive_ubatch_risk_kappa=self.adaptive_ubatch_risk_kappa,
            adaptive_ubatch_max_uncertainty_ratio=(
                self.adaptive_ubatch_max_uncertainty_ratio
            ),
            adaptive_ubatch_cold_start_penalty_ratio=(
                self.adaptive_ubatch_cold_start_penalty_ratio
            ),
            adaptive_ubatch_max_correction_ratio=(
                self.adaptive_ubatch_max_correction_ratio
            ),
            adaptive_ubatch_max_calibration_scale=(
                self.adaptive_ubatch_max_calibration_scale
            ),
            adaptive_ubatch_min_hold_steps=self.adaptive_ubatch_min_hold_steps,
            adaptive_ubatch_switch_confirmations=(
                self.adaptive_ubatch_switch_confirmations
            ),
            adaptive_ubatch_feedback_interval_steps=(
                self.adaptive_ubatch_feedback_interval_steps
            ),
            adaptive_ubatch_candidate_calibration_observations=(
                self.adaptive_ubatch_candidate_calibration_observations
            ),
            adaptive_ubatch_safe_m=self.adaptive_ubatch_safe_m,
            adaptive_ubatch_exploration_interval_steps=(
                self.adaptive_ubatch_exploration_interval_steps
            ),
            adaptive_ubatch_exploration_stable_steps=(
                self.adaptive_ubatch_exploration_stable_steps
            ),
