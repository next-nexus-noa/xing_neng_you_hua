...
class SchedulerOutput:
    ...
    # vLLM-Ascend PP micro-batch experiment metadata.
    # These fields are intentionally simple so Queue-Aware M can prove it only
    # used queue length to choose the PP micro-batch count.
    pp_queue_len: int | None = None
    pp_microbatch_num: int | None = None
